...
typedef struct
{
    int(*PNG_RCLoadImage_CheckBreak)(void *object, void* handle);
} IPngCheckBreak;

/* Read the whole image into memory at once. */
PNG_EXPORT(57, int, png_read_image, (png_structp png_ptr, png_bytepp image, IPngCheckBreak *checkBreak, void* handle));
#endif
